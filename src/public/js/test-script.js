...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    async function checkReaction() {
        if (selectedAcid && selectedBase) {
            ...
            if (
                product1 == answer1.textContent &&
                product2 == answer2.textContent
            ) {
                // MANAGE CURRENT SCORE
                ...
                setTimeout(() => {
                    ...
                    if (
                        questions[currentQuestion].split(" + ")[1].trim() ===
                        "-"
                    ) {
                ...
                // MANAGE CURRENT SCORE
                currentScore = currentScore == 0 ? 0 : currentScore - 50;
                ...
                if (hearts.length === 1) {
                    ...
                    overlayScore.textContent = `Current Score: ${currentScore}`;

                    if (currentScore > highestScore) {
                        console.log("Kita Masuk")
                        try {
                            ...
                            console.error(
                                "An error occurred while updating score:",
                                error
                            );
                        }
                    }
